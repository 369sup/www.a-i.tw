...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: { path: "^apps/web/src/modules/([^/]+)/([^/]+)/([^/]+)/domain/" },
      to: {
        path: "^apps/web/src/modules/$1/$2/$3/(application|contracts|adapters|composition)/",
      },
    },
    {
      ...
      to: { path: "^apps/web/src/modules/$1/$2/$3/adapters/" },
    },
    {
      ...
      to: {
        path: "^apps/web/src/modules/$1/$2/$3/(domain|application|adapters|composition)/",
      },
    },
    {
      name: "no-target-cross-context-internal-imports",
      severity: "error",
      comment:
        "Capability-template Contexts consume peers only through versioned Published Language.",
      from: {
        path: "^apps/web/src/modules/([^/]+)/([^/]+)/([^/]+)/(domain|application|contracts|adapters)/",
      },
      to: {
        path: "^apps/web/src/modules/[^/]+/[^/]+/[^/]+/(domain|application|adapters|composition)/",
        pathNot: "^apps/web/src/modules/$1/$2/$3/",
      },
    },
    {
      ...
      from: {
        ...
        pathNot: "^apps/web/src/composition/",
      },
      to: {
        path: "^apps/web/src/modules/[^/]+/[^/]+/[^/]+/(domain|application|contracts|adapters|composition)/",
      },
    },
    {
      name: "server-composition-uses-context-entrypoints",
      severity: "error",
      comment:
        "App composition consumes Context composition or public-api entrypoints, not internals.",
      from: { path: "^apps/web/src/composition/" },
      to: {
        path: "^apps/web/src/modules/[^/]+/[^/]+/[^/]+/(domain|application|contracts|adapters|tests)/",
      },
    },
    {
    ...
    {
      name: "technical-packages-do-not-depend-on-applications",
      severity: "error",
      comment:
        "Reusable technical packages cannot depend on deployable applications or app-local product Contexts.",
      from: { path: "^packages/" },
      to: { path: "^apps/" },
    },
  ],
