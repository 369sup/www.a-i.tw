...
`consumer/adapters/outbound/integrations` and alone may know provider Published Language. Provider DTO, status and
error vocabulary must be mapped to consumer-local decisions.
