...
Peer Contexts never assemble each other. `apps/web/src/composition` may import Context `public-api.ts`,
`composition/index.ts`,
instantiate provider facades, construct consumer ACL adapters and inject them into consumer
