...
Project is a User- or Organization-owned planning and access boundary. Repository may link to Project
but does not own it.
...
Pull Request item semantics are excluded. A Projects Context requires G1-G3 before scaffold.
