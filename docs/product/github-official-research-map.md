...
| ------------------------------------ | --------------------------------------------- | ----------------------------------------------- | --------------- | ----------------------------------- |
| User/Organization/Enterprise account | Governance roots                              | Account / future Enterprise Governance          | Partial         | `account-and-profile-presence.md`   |
...
| Discussions                          | Conversation Context                          | Discussions                                     | Partial Current | `discussions-community.md`          |
| Follow/Star/Watch                    | Distinct relationship families                | Social Graph / Subscription                     | Research        | `github-non-code-semantic-model.md` |
| Notifications                        | Delivery and Inbox lifecycle                  | Notification                                    | Research        | `notification.md`                   |
| Search                               | Query capability                              | Search                                          | Research        | `search.md`                         |
| App/Installation/Authorization       | Separate definition and delegation lifecycles | App Registry / App Installation & Authorization | Research        | `github-non-code-semantic-model.md` |
| Webhook Subscription/Delivery        | Integration delivery lifecycle                | Webhook Delivery                                | Research        | `github-non-code-semantic-model.md` |
...
- Repository 的 ownership、namespace、profile、visibility、state、feature configuration 與 lifecycle；Repository
  access 僅作為 Authorization & Policy 的 Repository-scoped 關係研究，不歸入 Repository Aggregate。
...
| [Repositories](https://docs.github.com/en/repositories)                                           | ownership、visibility、profile、feature toggles、transfer、archive、delete、Repository-scoped access and Issue／Discussion／Project relations        | branches、merges、files、source code、Git LFS、Actions、code security           | Repository core；access/relations 路由到各自唯一 owner   |
...
| [Enterprise onboarding](https://docs.github.com/en/enterprise-cloud@latest/enterprise-onboarding) | enterprise setup、organizations、enterprise teams、users、roles、identity、licensing                                                                 | repository code migration mechanics                                             | `enterprise-account-and-governance.md`、`entitlement.md` |
| [Enterprise administration](https://docs.github.com/en/enterprise-cloud@latest/admin)             | policy、identity federation、managed users、roles、billing、license、cost center、audit、Apps、organization governance                               | Actions、runner、code-security administration                                   | `enterprise-account-and-governance.md`、`entitlement.md` |
...
| [Subscriptions and notifications](https://docs.github.com/en/subscriptions-and-notifications)     | Subscription／Watch preference 與 Notification／Inbox delivery lifecycle，分開萃取                                                                   | PR、release、Actions 與 code-security-specific payloads                         | Subscription、Notification 各自 owner                    |
| [Issues](https://docs.github.com/en/issues)                                                       | lifecycle、types、labels、milestones、assignment、sub-issues、dependencies、templates、forms、comments                                               | Pull Request-specific behavior                                                  | Issues product research                                  |
...
| [Using GitHub Apps](https://docs.github.com/en/apps/using-github-apps)                            | App definition、Installation、user Authorization、requested permissions、resource selection、approval、suspension、revocation，按 lifecycle 分開萃取 | App implementation、API authentication 與 source code                           | App Registry；App Installation & Authorization           |
