...
| `https://github.com/issues`                  | Authenticated cross-Repository work projection           | active actor; viewer-visible Issues across scopes                               | Issues read model                          | supplied；requires observed filter inventory |
