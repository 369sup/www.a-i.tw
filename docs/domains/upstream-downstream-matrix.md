...
| Account               | Enterprise Governance | Organization eligibility facts                      | Customer/Supplier + Published Language + ACL | own affiliation; reject invalid Organization         |
| Enterprise Governance | Repository            | Repository visibility constraints                   | Customer/Supplier + Published Language + ACL | own final decision; do not copy Enterprise hierarchy |
