...
|  16 | Composition Root           | Reviewed — no impact | product workspace is only concrete wiring root   |
...
- `RepositoryService.grantTeam` is invoked by the workspace Server Action inbound adapter.
