...
| GitHub 非 Code 完整語意       | `product/github-non-code-semantic-model.md`    | official evidence、concept owner、classification  |
| Knowledge Wiki 邊界           | `product/repository-wiki.md`                   | approved first slice、invariants、dependency      |
| Community Safety 邊界         | `product/community-safety.md`                  | interaction limit、decision、moderation boundary  |
| 世界模型與橫切控制平面        | `product/platform-world-model.md`              | primitives、relationship、planes、runtime status  |
| Enterprise governance         | `product/enterprise-account-and-governance.md` | account/team governance、runtime status           |
...
| Account／Profile／Presence    | `product/account-and-profile-presence.md`      | account identity、profile、presence、privacy      |
| Social graph／Social Curation | `product/social-graph.md`                      | approved Repository Star、follow/watch boundaries |
...
| 腳手架與可執行架構範本        | `architecture/context-internal-topology.md`    | three-level placement、template v2 與 enforcement |
...
Architecture target routing: `architecture/context-internal-topology.md` owns ADR 0014 placement and ADR 0011 capability-oriented Context
topology and the retained fixed Domain Group placement;
