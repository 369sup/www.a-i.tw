    ...
    <header className="flex h-15 items-center justify-between border-b bg-background px-4 lg:px-5">
      ...
      <div className="flex items-center gap-1.5">
        <label className="relative hidden lg:block" htmlFor="global-search">
          ...
          <input
            className="h-8 w-48 rounded-md border bg-background pl-9 pr-3 text-xs outline-none focus:ring-2 focus:ring-ring xl:w-56"
            id="global-search"
        ...
        <button
          ...
          className="relative inline-flex size-8 items-center justify-center rounded-md border hover:bg-muted"
          title="Notifications"
          type="button"
        >
        ...
        <div className="relative hidden sm:block">
          <button
            ...
            className="inline-flex h-8 items-center gap-1 rounded-md border px-2 text-sm hover:bg-muted"
            type="button"
          >
