...
import { createSubTemplateService } from "../src/subdomains/sub-template/application/sub-template-service";
import { InMemorySubTemplateCatalog } from "../src/subdomains/sub-template/infrastructure/in-memory-sub-template-catalog";
