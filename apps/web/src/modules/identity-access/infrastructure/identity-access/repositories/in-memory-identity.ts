import type { AuthenticatedPrincipalV1 } from "../../../contracts/identity-access/public";
import type { Principal } from "../../../domain/identity-access/entities/principal";
import type {
  PrincipalStore,
  CredentialVerifier,
  SessionStore,
} from "../../../application/identity-access/use-cases/identity-service";
